...
2. A heuristic looks at the recent turns. Ordinary chat (“high”, “how’s it going”) does **not** fetch.
3. Games/stats (or a matching general-pack question) → HTTPS GET the published URL.
